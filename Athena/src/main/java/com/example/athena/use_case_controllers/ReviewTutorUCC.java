...
import com.example.athena.boundaries.SendReviewCodeToStudentBoundary;
...
public class ReviewTutorUCC
{
    public ReviewCodeBean insertReview(ReviewInfoBean reviewBean) throws TutorReviewException, SendEmailException
    {
        ...
        SendCodeMailBean mailInformation = new SendCodeMailBean(reviewBean.getStudentMail(), reviewCode) ;
        SendReviewCodeToStudentBoundary.getInstance().sendCode(mailInformation) ;
